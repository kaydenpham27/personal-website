...
const GitHubStats = (props: GitHubStatsProps) => {
  ...
  return (
    <div className="flex flex-row">
      ...
      <div className="github-repo__content">
        <div className="github-repo__name">{repoData?.full_name}</div>
        <ul className="github-repo__stats">
          <li className="github-repo__stat github-repo__stat--stars">
            {repoData?.stargazers_count}
          </li>
          <li className="github-repo__stat github-repo__stat--forks">
