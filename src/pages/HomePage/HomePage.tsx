      ...
      <Card className="w-full">
        ...
        <CardContent className="flex flex-col text-start gap-2">
          ...
          <Typography.Small className="font-thin leading-5">
            ...
            products. It seems like a boring job; however, I think I actually
            enjoy it! Building integrations is like solving ad-hoc communication
            problems for systems, and once you get them talking to each other,
            you tend to gain some sort of satisfaction and have some fun.
          </Typography.Small>
          <Typography.Small className="font-thin leading-5">
            My early passion in high school was doing Competitive Programming.
            Yes, if you are not familiar with the term, it's somewhat similar to
          ...
          <Typography.Small className="font-thin leading-5">
            If you have any questions, want to discuss further on a topic, or
            simply just want to say hi. You can email me directly or connect
            with me on LinkedIn through various links I placed on my website.
            Please feel encouraged to do any of the above!
          </Typography.Small>
        </CardContent>
      </Card>
      <div>
